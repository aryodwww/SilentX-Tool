...
def InstallDependencies():
    print(f"{INFO} Installing the Python dependencies required for the SilentX-Tools:")
...
parser = argparse.ArgumentParser(description="SilentX-Tools setup")
