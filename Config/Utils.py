...
path_file_tool                          = os.path.join(path_folder_tool,   "silentx.py")
...
tool_name, tool_version, tool_license, tool_github, developer, website, telegram, gunslol, discord, twitter = (
    ...
    data_credits.get("discord", None),
    data_credits.get("twitter", None),
)
...
class SilentXArgumentParser(argparse.ArgumentParser):
